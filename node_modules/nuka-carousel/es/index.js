...
function (_React$Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var slideCount = React.Children.count(nextProps.children);
      ...
      var updateDimensions = slideCountChanged || function (curr, next, keys) {
        ...
        return shouldUpdate;
      }(this.props, nextProps, ['cellSpacing', 'vertical', 'slideWidth', 'slideHeight', 'heightMode', 'slidesToScroll', 'slidesToShow']);
    ...
    value: function getSlideTargetPosition(index, positionValue) {
      ...
      var startSlide = Math.min(Math.abs(Math.floor(positionValue / this.state.slideWidth)), this.state.slideCount - 1);

      if (this.props.wrapAround && index !== startSlide) {
        var direction = this.getSlideDirection(startSlide, this.state.currentSlide, this.state.isWrappingAround);
        var slidesBefore = Math.floor((this.state.slideCount - 1) / 2);
        var slidesAfter = this.state.slideCount - slidesBefore - 1;
        ...
        if (index < startSlide) {
          if (distanceFromStart > slidesBefore) {
            targetPosition = (this.state.slideWidth + this.props.cellSpacing) * (this.state.slideCount + index);
          }
        } else if (distanceFromStart > slidesAfter) {
          targetPosition = (this.state.slideWidth + this.props.cellSpacing) * (this.state.slideCount - index) * -1;
        }
      }
    ...
    value: function render() {
      ...
      }), this.renderControls(), React.createElement("style", {
        type: "text/css",
